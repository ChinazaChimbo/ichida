    ...
    if (!empty($_POST['by']) && !empty($_POST['amount'])) {
      ...
      if (is_numeric($amount)) {
        ...
        if ($bbalance >= $amount) {
          ...
          $inlog = mysqli_query($con, "INSERT INTO bank_log VALUES('', 'Bank Withdrawal', '".$by."', 'Bank Withdrawal', '".$amount."', '".$bname."', '".$date."')");
          $inacc = mysqli_query($con, "INSERT INTO acc_log VALUES('', 'Bank Withdrawal', '".$by."', 'Bank Withdrawal', '".$amount."', '".$bname."', '".$date."')");
          $msg = "<div class='alert alert-success'>
                    Withdrawal Completed successfully. 
                  </div>";
        } else {
          $msg = "<div class='alert alert-danger'>
                  Amount must be greater than account balance. 
                </div>";
        }
...
<div class="form-group">
  ...
  <div class="text-center">
      <input type="submit" value="Withdraw" name="submit" class="btn btn-info">
  </div>
  <?php echo $msg;?>
