<?php
    ...
    $member = mysqli_real_escape_string($con, $_SESSION['member']);
...
<head>
    ...
    <title>Ichida Progress Union | Paid Levies</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><?php echo $title." ".$fname." ".$oname." ".$sname;?> PAID LEVIES</h6>
            </div>
            <div class="card-body">
