<?php
    ...
    $check = mysqli_query($con, "SELECT * FROM income ORDER BY date DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Ichida Progress Union | Income Log</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Income Log</h6>
            </div>
            <div class="card-body">
